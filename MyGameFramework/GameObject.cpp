...
{
	GameObject::GameObject(Scene* scene) : m_owner(scene) { }
	...
	GameObjectUPtr GameObject::Create(Scene* scene)
	{
		return GameObjectUPtr(new GameObject(scene));
	}
	...
	//===================================*/
	void GameObject::Awake() { for (const ComponentUPtr& component : m_components) component->Awake(); }
	void GameObject::Start() { for (const ComponentUPtr& component : m_components) component->Start(); }
